...
#filename = "../data/pubchem-10k.txt"
#filename = "../data/cyclic_smiles_only.csv"
filename = "filtered_smiles_len30.csv"  #"cyclic_smiles_only_augmented.csv"
# Directory to serialize a tokenizer and model.
checkpoint = "benchmark-10m"
tokenizer_filename = "cylic_smile_tokenizer_on_pretrain_with_toekn_perm.json" #"cylic_smile_tokenizer_on_cyclic_aug_toy.json" #"cylic_smile_tokenizer.json" #"../checkpoints/{checkpoint}/tokenizer.json"

# Tokenizer, model, optimizer, scheduler, and trainer hyperparameters.
hyperparams = {"batch_size": 256, "max_epochs": 300, "min_epochs": 10,
               "max_length": 256, "learning_rate": 5e-5, "weight_decay": 0.0,
...
trainer = Trainer(
    ...
    logger=logger,
    strategy="auto",#"dp",
    callbacks=[checkpoint_cb, early_stopping_val, ValiditySamplingCallback(tokenizer, n_samples=20, output_dir="generated_samples")],
