...
tokenizer_filename = f"../checkpoints/{checkpoint}/tokenizer.json"
...
trainer = Trainer(
    #gpus=gpus,
    strategy="auto",#"dp",
    callbacks=[checkpoint_cb, early_stopping_ppl, ValiditySamplingCallback(tokenizer, n_samples=20, output_dir="generated_samples")],
