...
tokenizer_filename = "cylic_smile_tokenizer_on_cyclic_aug_toy.json" #"cylic_smile_tokenizer.json" #"../checkpoints/{checkpoint}/tokenizer.json"

# Tokenizer, model, optimizer, scheduler, and trainer hyperparameters.
hyperparams = {"batch_size": 128, "max_epochs": 300, "min_epochs": 15,
